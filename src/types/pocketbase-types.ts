...
export type CampaignResponse<Texpand = unknown> =
	& Required<CampaignRecord>
	& BaseSystemFields<Texpand>;
export type FormItemQuestionResponse<Tvalues = unknown, Texpand = unknown> =
	& Required<FormItemQuestionRecord<Tvalues>>
	& BaseSystemFields<Texpand>;
export type FormItemTypeResponse<Tschema = unknown, Texpand = unknown> =
	& Required<FormItemTypeRecord<Tschema>>
	& BaseSystemFields<Texpand>;
export type FormTemplateResponse<Tquestions = unknown, Texpand = unknown> =
	& Required<FormTemplateRecord<Tquestions>>
	& BaseSystemFields<Texpand>;
