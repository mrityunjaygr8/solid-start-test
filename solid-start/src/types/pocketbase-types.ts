...
export type CampaignResponse<Texpand = unknown> = Required<CampaignRecord> &
  BaseSystemFields<Texpand>;
export type FormItemQuestionResponse<
  Tvalues = unknown,
  Texpand = unknown
> = Required<FormItemQuestionRecord<Tvalues>> & BaseSystemFields<Texpand>;
export type FormItemTypeResponse<
  Tschema = unknown,
  Texpand = unknown
> = Required<FormItemTypeRecord<Tschema>> & BaseSystemFields<Texpand>;
export type FormTemplateResponse<
  Tquestions_dep = unknown,
  Texpand = unknown
> = Required<FormTemplateRecord<Tquestions_dep>> & BaseSystemFields<Texpand>;
export type SubmissionsResponse<
  Tanswers = unknown,
  Texpand = unknown
> = Required<SubmissionsRecord<Tanswers>> & BaseSystemFields<Texpand>;
export type TemplateViewResponse<Texpand = unknown> =
  Required<TemplateViewRecord> & BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: "formItemQuestion"
  ): RecordService<FormItemQuestionResponse>;
